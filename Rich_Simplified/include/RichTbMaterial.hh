...
class RichTbMaterial {
  ...
  G4Material* getPMTFrontRingMaterial() {

    return PMTFrontRingMaterial ;
  }

  G4Material*  getPMTModuleBackPlMaterial() 
  { return  PMTModuleBackPlMaterial ; }
 ...
 G4Material* getCrystalMaterial() 
  ...
  G4Material* getRichTbCarbonFibreMaterial() {return RichTbCarbonFibreMaterial; }
  ...
  static RichTbMaterial* RichTbMaterialInstance;
    ...
    G4Material* PMTModuleBackPlMaterial;
    G4Material* PMTFrontRingMaterial;
    ...
    G4Material* RichTbCarbonFibreMaterial;
