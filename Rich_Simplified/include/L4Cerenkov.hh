...
public:
	...
	~L4Cerenkov();
        ...
        L4Cerenkov(const L4Cerenkov &right);
...
inline
G4bool L4Cerenkov::GetTrackSecondariesFirst() const
{
        return fTrackSecondariesFirst;
}

inline
G4double L4Cerenkov::GetMaxBetaChangePerStep() const
{
        return fMaxBetaChange;
}

inline
G4int L4Cerenkov::GetMaxNumPhotonsPerStep() const
{
        return fMaxPhotons;
}

inline
void L4Cerenkov::DumpPhysicsTable() const
{
...
inline
G4PhysicsTable* L4Cerenkov::GetPhysicsTable() const
{
