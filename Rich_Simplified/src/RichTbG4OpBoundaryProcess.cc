...
RichTbG4OpBoundaryProcess::PostStepDoIt(const G4Track& aTrack, const G4Step& aStep)
{
  ...
  //     G4cout<< "RichTbBoundaryPro Mom wlen preDir "<< aTrack.GetMomentum()<<"      "
  //    <<  aTrack.GetMomentumDirection()<< G4endl;

  //    G4cout<< "RichTbBoundaryPro prsetp poststep pt "<<  pPreStepPoint->GetPosition() <<"   "
  //           << pPostStepPoint ->GetPosition()<<G4endl;
